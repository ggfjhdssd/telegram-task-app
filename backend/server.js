...
const userSchema = new mongoose.Schema({
  ...
  dailyLastClaim: { type: Number, default: 0 }, // timestamp (ms)
  tasks: { type: Map, of: Number, default: {} } // taskId -> unlock timestamp
});
...
function validateTelegramData(initData) {
  ...
  // Create HMAC-SHA256 hash using bot token
...
// ---------- Middleware: extract & validate user ----------
...
// GET /api/user – returns user data (coins, daily, tasks)
